(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://mzavaletavargas.github.io/wiki/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://mzavaletavargas.github.io/wiki/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://mzavaletavargas.github.io/wiki/assets/css/just-the-docs-' + theme + ".css"
      );
    };
