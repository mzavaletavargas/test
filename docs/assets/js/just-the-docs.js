(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://mzavaletavargas.github.io/test/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://mzavaletavargas.github.io/test/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://mzavaletavargas.github.io/test/assets/css/just-the-docs-' + theme + ".css"
      );
    };
